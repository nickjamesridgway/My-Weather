...
var containerFamousCities = document.querySelector("#famousCities");
...
var loadCity = function(){
    ...
    cleaningElement(containerFamousCities);
        ...
        if(dataStore){
           ...
           //Create a loop so you can list the cities
            for(var i = 0; i < dataStore.length; i++){
                ...
                containerFamousCities.appendChild(ulElement); 
            }
};
...
//Create the array of object to store information 
...
var callApiFetch = function(city){
    ...
    .then(function(weatherResponse) {
        ...
        //If you can't connect, then display this message
